$(window).scroll(function(){
  ...
  if (scroll >= 100){
  	...
  	fakeheader.removeClass('hide');
  } else {
  	sticky.removeClass('fixed');
  	fakeheader.addClass('hide');
  } 
});
...
$('#menu-topmenu > li').on({
    mouseenter: function () {
        $(this).addClass('hover');
        $(this).find('div ul').slideDown('fast');//addClass('fadeInDown');
    },
    mouseleave: function () {
        $(this).removeClass('hover');
        $(this).find('div  ul').hide();//removeClass('fadeInDown');
    }
});
$('.image-wrap').on({
    mouseenter: function () {
        $(this).addClass('hover');
        $(this).find('div.before').addClass('hover');
    },
    mouseleave: function () {
        $(this).removeClass('hover');
        $(this).find('div.before').removeClass('hover');
    }
});
