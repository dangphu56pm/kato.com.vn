...
$this->language->load('common/to_header');
...
$this->data['text_filemanager'] = $this->language->get('text_filemanager');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['redirect'] = $this->url->link('tool/redirect', 'token=' . $this->session->data['token'], 'SSL');			
			...
			$this->data['menu'] = $this->url->link('menu/menus', 'token=' . $this->session->data['token'], 'SSL');
