...
<div id="container">
  ...
  <div file="" style="float: right; color: lightblue;"><a href="<?php echo $cancel; ?>" class="button"><?php echo "Close"; ?></a></div><div id="updateImage" file="" style="float: right;"><a class="button">Insert</a></div></div>
