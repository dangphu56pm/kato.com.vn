          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="left"><select name="slideshow_module[<?php echo $module_row; ?>][position]">
                  ...
                  <option value="slideside" selected="selected"><?php echo "Slide"; ?></option>
                  <?php } else { ?>
                  <option value="slideside"><?php echo "Slide"; ?></option>
                  <?php } ?>
...
function addModule() {	
	...
	html += '      <option value="slideside"><?php echo "Slide"; ?></option>';
