    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table id="module" class="list">
        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr>
            <td class="left"><input type="text" name="video_module[<?php echo $module_row; ?>][limit]" value="<?php echo $module['limit']; ?>" size="1" /></td>          
...
function addModule() {
	...
	html += '  <tr>';
	html += '    <td class="left"><input type="text" name="video_module[' + module_row + '][limit]" value="5" size="1" /></td>';	
