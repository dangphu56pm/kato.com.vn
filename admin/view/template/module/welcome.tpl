    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div class="vtabs">
          ...
          <a href="#tab-module-<?php echo $module_row; ?>" id="module-<?php echo $module_row; ?>"><input type="text" name="welcome_module[<?php echo $module_row; ?>][tab]" value="<?php echo $module['tab']; ?>"/>&nbsp;<img src="view/image/delete.png" alt="" onclick="$('.vtabs a:first').trigger('click'); $('#module-<?php echo $module_row; ?>').remove(); $('#tab-module-<?php echo $module_row; ?>').remove(); return false;" /></a>
          <?php $module_row++; ?>
          <?php } ?>
          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><select name="welcome_module[<?php echo $module_row; ?>][position]">
                  <?php if ($module['position'] == 'adv_top') { ?>
                  <option value="adv_top" selected="selected">Quảng cáo đầu trang</option>
                  <?php } else { ?>
                  <option value="adv_top">Quảng cáo đầu trang</option>
                  <?php } ?>
...
function addModule() {	
	...
	html += '        <option value="adv_top">Quảng cáo đầu trang</option>';
	...
	$('#module-add').before('<a href="#tab-module-' + module_row + '" id="module-' + module_row + '"><input type="text" name="welcome_module[' + module_row + '][tab]" value=""/>&nbsp;<img src="view/image/delete.png" alt="" onclick="$(\'.vtabs a:first\').trigger(\'click\'); $(\'#module-' + module_row + '\').remove(); $(\'#tab-module-' + module_row + '\').remove(); return false;" /></a>');
