          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="left"><select name="menu_module[<?php echo $module_row; ?>][layout_id]">
                  ...
                  <?php } ?>
                  <?php if ($module['position'] == 'top_menu') { ?>
                  ...
                  <option value="footer_menu" selected="selected">Footer Menu</option>
                  <?php } else { ?>
...
function addModule() {	
	...
	html += '      <option value="top_menu">Top Menu</option>';
	html += '      <option value="footer_menu">Footer Menu</option>';
	html += '    </select></td>';
