    ...
    <div class="content">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
            ...
            <table class="form">
			  ...
			  <tr>
					<td><?php echo "SEO title"; ?></td>
					  <td><input type="text" name="category_description[<?php echo $language['language_id']; ?>][meta_title]" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['meta_title'] : ''; ?>" size="100" onKeyDown="textCounter(this,70);"
              ...
              <tr>
                <td><?php echo $entry_meta_description; ?></td>
				  <td >
	                <textarea size="100"  name="category_description[<?php echo $language['language_id']; ?>][meta_description]" cols="45" rows="5"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
	                <br />
	            </td>
              </tr>
            </table>
        ...
        <div id="tab-data">
          <table class="form">
            <tr>
              <td><?php echo $entry_parent; ?>
	              <span class="help">Nhập số 0 hoặc nhập tên danh mục cha</span>
              </td>
            ...
            <tr>
              ...
              <td><input type="text" name="keyword" size="60" value="<?php echo $keyword; ?>" /></td>
            </tr>
            <tr>
