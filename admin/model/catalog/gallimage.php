...
class ModelCatalogGallimage extends Model {
	public function addGallimage($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "gallimage SET name = '" . $this->db->escape($data['name']) . "', name_en = '" . $this->db->escape($data['name_en']) . "', status = '" . (int)$data['status'] . "'");
	...
	public function editGallimage($gallimage_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "gallimage SET name = '" . $this->db->escape($data['name']) . "', name_en = '" . $this->db->escape($data['name_en']) . "', status = '" . (int)$data['status'] . "' WHERE gallimage_id = '" . (int)$gallimage_id . "'");
