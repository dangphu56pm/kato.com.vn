...
class ControllerCommonFileManager extends Controller {
    ...
    public function cleanString($text) {
        // 1) convert á ô => a o
        $text = preg_replace("/[áàâãªäảạ]/u", "a", $text);
        $text = preg_replace("/[ÁÀÂÃÄẢẠ]/u", "A", $text);
        $text = preg_replace("/[ÍÌÎÏỈỊ]/u", "I", $text);
        $text = preg_replace("/[íìîïỉị]/u", "i", $text);
        $text = preg_replace("/[éèêëẻẹ]/u", "e", $text);
        $text = preg_replace("/[ÉÈÊËẺẸ]/u", "E", $text);
        $text = preg_replace("/[óòôõºöỏọ]/u", "o", $text);
        $text = preg_replace("/[ÓÒÔÕÖỎỌ]/u", "O", $text);
        $text = preg_replace("/[úùûüủụ]/u", "u", $text);
        $text = preg_replace("/[ứừửự]/u", "u", $text);
        $text = preg_replace("/[ÚÙÛÜỦ]/u", "U", $text);
        $text = preg_replace("/[ỨỪỬỰ]/u", "U", $text);
