...
class ControllerMenuMenus extends Controller {
	...
	public function getList(){
		...
		foreach ($results as $result) {
			...
			$this->data['menus'][] = array(
					...
					'menu_name_en'   => $result['menu_name_en'],
	...
	private function getForm() {
		...
		if (isset($this->request->post['menu_name_en'])) {
			$this->data['menu_name_en'] = $this->request->post['menu_name_en'];
		} elseif (!empty($menu_info)) {
			$this->data['menu_name_en'] = $menu_info['menu_name_en'];
		} else {
			$this->data['menu_name_en'] = '';
		}
