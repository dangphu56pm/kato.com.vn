...
class ControllerCatalogNews extends Controller {
    ...
    public function sort() {
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST') {
            ...
            if (count($sort_order > 0)) {
                $this->model_catalog_news->changeSort($sort_order);
            }
    ...
    public function insert() {
        ...
        // $this->document->setTitle($this->language->get('heading_title')); 
        $this->document->setTitle('Tạo tin tức mới');
    ...
    public function update() {
        ...
        if (isset($this->request->get['news_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $news_info = $this->model_catalog_news->getNameNew($this->request->get['news_id']);
    ...
    private function getList() {
        ...
        $this->data['save_sort'] = $this->url->link('catalog/news/sort', 'token=' . $this->session->data['token'] . $url, 'SSL');
        ...
        $this->data['news_category'] = $this->model_catalog_news_category->getNewsCategories(0);
        ...
        // var_dump($this->data['filter_category']);
    ...
    public function checkKeyword() {
        ...
        if (strlen($keyword) > 0) {
            $this->load->model('catalog/news');
            $results = $this->model_catalog_news->checkKeywords($data);
...
//        print_r($this->session->data['sql_auto']);
        $this->data['heading_title'] = $this->language->get('heading_title');
