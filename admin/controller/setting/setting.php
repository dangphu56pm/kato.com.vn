...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['tab_local_seo'] = $this->language->get('tab_local_seo');
		...
		if (isset($this->request->post['config_hocngay'])) {
			$this->data['config_hocngay'] = $this->request->post['config_hocngay'];
		} else {
			$this->data['config_hocngay'] = $this->config->get('config_hocngay');
		}
		
		if (isset($this->request->post['config_plus'])) {
			$this->data['config_plus'] = $this->request->post['config_plus'];
		} else {
			$this->data['config_plus'] = $this->config->get('config_plus');
		}
		...
		$directories = glob(BASE_DIR . '/theme/*', GLOB_ONLYDIR);
		...
		if (isset($this->request->post['config_google_remark'])) {
			$this->data['config_google_remark'] = $this->request->post['config_google_remark']; 
		} else {
			$this->data['config_google_remark'] = $this->config->get('config_google_remark');
		}
	...
	protected function validate() {
        ...
        if(!isset($this->request->post['config_address']) || empty($this->request->post['config_address'])) {
        ...
        // if(!isset($this->request->post['config_title']) || empty($this->request->post['config_title'])) {
            // $this->error['address'] = $this->language->get('error_address');
        // }
