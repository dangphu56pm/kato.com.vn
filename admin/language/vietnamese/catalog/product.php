...
$_['entry_manufacturer']     = 'Hãng sản xuất:<br/><span class="help">Nhập chữ cái đầu tiên tên hãng (Hoặc số 0 để hiển thị danh sách tất cả các hãng). Hệ thống sẽ tự động lọc tìm kiếm, sau đó dùng các phím lên xuống hoặc chuột để chọn tên hãng</span>';
...
$_['entry_category']         = 'Danh mục:<br/><span class="help">Nhập chữ cái đầu tiên tên danh mục (Hoặc số 0 để hiển thị danh sách tất cả các danh mục). Hệ thống sẽ tự động lọc tìm kiếm, sau đó dùng các phím lên xuống hoặc chuột để chọn tên danh mục</span>';
